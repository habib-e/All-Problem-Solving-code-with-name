...
int user1_validity() //should return 1 on success
{
    ...
    for(i=70; i<=(70+245); i=i+35)
        ...
        {
            if(validity_enabler) //which cannot reach after checking
                array[7][7]
    ...
    if(validity_enabler)
        return(1); //which is to check whether
    validity_enabler got rised after checking for array[7]
        [7]
        color=col1;
    sp_color=col2;
    return(0);
